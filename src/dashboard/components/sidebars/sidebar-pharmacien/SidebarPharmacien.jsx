...
export const SidebarPharmacien = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <NavLink to={"/medicaments"} style={{ textDecoration: "none" }}>
          <ListItem>
            <ListItemButton color="primary">
              <ListItemDecorator>
                <FaNotesMedical />
              </ListItemDecorator>
              <ListItemContent>Médicaments</ListItemContent>
            </ListItemButton>
          </ListItem>
        </NavLink>
        <NavLink to={"/manquants"} style={{ textDecoration: "none" }}>
          <ListItem>
            <ListItemButton color="primary">
              <ListItemDecorator>
                <FaArrowTrendDown />
              </ListItemDecorator>
              <ListItemContent>Manquants</ListItemContent>
            </ListItemButton>
          </ListItem>
        </NavLink>
